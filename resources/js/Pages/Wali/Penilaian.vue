       ...
       init(){
        ...
        getNilais() {
            ...
            if(this.$page.props.mapel == null) {
                ...
                axios({
                    method: 'post',
                    url: '/wali/nilai?role='+this.$page.props.user.role
                }).then( res => {
                    var datas = res.data.ikhtisar
                    var items = []
                    Object.values(datas).forEach(item => {
        ...
        getRombels(){
            axios.post('/wali/rombel?periode='+this.$page.props.periode_aktif.kode_periode)
                .then( res => {
                    var rombels = []
        ...
        getMapels(){
            axios.post('/wali/mapel?tingkat='+this.$page.props.rombel.kelas_id)
                .then(res => {
                    var mapels = []
